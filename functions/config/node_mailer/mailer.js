      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
          ...
          <div style="padding: 20px;">
            ...
            <!-- Product Card -->
            <div style="background: #f9f9f9; border-radius: 8px; padding: 15px; margin: 20px 0; display: flex; gap: 15px;">
              ${
                productImage
              ...
              <div>
                <h2 style="margin: 0 0 8px 8px; color: #2c3e50;">${productName}</h2>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="${process.env.FRONTEND_URL}/checkout" 
